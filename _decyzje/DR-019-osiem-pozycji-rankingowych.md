---
id: DR-019
tytul: Osiem pozycji rankingowych — trzy krajowe i pięć otwartych
typ: merytoryczna
status: przyjęta
...
discussion_url: ""
pr_url: https://github.com/Fencer4Life/Regulamin_Kadry-SPWS/pull/37
...
Dotychczasowa norma określała wyłącznie trzy najwyżej punktowane wyniki z PPW i MPW. Nie określała łącznej liczby wyników w rankingu, sposobu uzupełniania brakujących wyników ani relacji pomiędzy wynikami krajowymi i pozostałymi zawodami.

## Kontekst

W sezonie odbywa się pięć zawodów zaliczanych do krajowego cyklu weteranów, obejmującego PPW i MPW. Zawodnik powinien mieć swobodę wyboru startów, ale ranking ma wymagać trzech wyników krajowych. Pozostałe wyniki mogą pochodzić zarówno z dodatkowych startów PPW lub MPW, jak i z zawodów seniorskich PZSz oraz zawodów weteranów EVF i FIE.
...
Odrzucono pozostawienie niepełnej normy dotyczącej wyłącznie trzech wyników krajowych oraz wybór ośmiu wyników bez obowiązkowej puli PPW i MPW.

## Plan oceny

Po sezonie porównać wpływ trzech pozycji krajowych i pięciu pozycji otwartych na kolejność rankingu, liczbę zer oraz zróżnicowanie kalendarzy startowych zawodników.
...
- 2026-09-19 — decyzja przyjęta i przeznaczona do wdrożenia w PR #37.
