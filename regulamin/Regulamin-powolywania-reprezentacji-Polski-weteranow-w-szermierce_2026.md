...
| Data projektu | [data] TEST-ETYKIETA-FINAL-58 |
<!-- /publication -->
...
## Rozdział 1 — Postanowienia ogólne <!-- chapter:postanowienia-ogolne -->
<!-- scope: przedmiot, definicje i zasady wyłaniania reprezentacji -->
...
<!-- unit:definicje-wprowadzenie --> Ilekroć w Regulaminie jest mowa o:
   1) <!-- unit:definicja-spws --> **SPWS** – należy przez to rozumieć Stowarzyszenie Polskich Weteranów Szermierki;
...
### § 3 — Cel i zasady wyłaniania reprezentacji <!-- section:cel -->
...
2. <!-- unit:cel-zasady --> Proces wyłaniania reprezentacji opiera się na następujących zasadach:
   1) <!-- unit:zasada-szeroki-wybor --> **szerokiego wyboru zawodów** – w rankingu indywidualnym uwzględnia się wyniki uzyskane w zawodach ujętych w kalendarzach SPWS, PZSz, EVF i FIE, na zasadach określonych w § 5 ust. 1<!-- ref:zawody-rankingowe/katalog-zawodow -->;
...
1. <!-- unit:czynniki-punktacji --> Liczba punktów przyznawanych za wynik uzyskany w zawodach zależy od zajętego miejsca, liczby zawodników w stawce oraz współczynnika rangi określonego dla danego rodzaju zawodów.

2. <!-- unit:wspolczynniki-wprowadzenie --> W sezonie 2026/2027 stosuje się następujące współczynniki rangi zawodów.


{{table:rank-coefficients}}
...
3. <!-- unit:tabela-punktacji --> Tabela punktacji dla stawki liczącej od 4 do 40 zawodników stanowi załącznik nr 1 do Regulaminu. Pełną tabelę punktacji dla stawki liczącej od 4 do 300 zawodników SPWS publikuje na swojej stronie internetowej.

4. <!-- unit:kalkulator-punktow --> SPWS zapewnia publiczny i nieodpłatny dostęp do kalkulatora punktów, umożliwiającego sprawdzenie liczby punktów przyznawanych za konkretny wynik uzyskany w zawodach.
...
### § 8 — Wyniki w połączonych kategoriach wiekowych <!-- section:polaczone-kategorie -->
...
## Rozdział 3 — Powołania do startów indywidualnych <!-- chapter:powolania-indywidualne -->
...
### § 13 — Kategorie wiekowe w drużynie <!-- section:kategorie-druzynowe -->
...
### § 16 — Powołanie uzupełniające <!-- section:powolanie-uzupelniajace-druzyna -->

<!-- unit:powolanie-uzupelniajace-odeslanie --> Powołanie uzupełniające zawodnika bez dodatniego dorobku punktowego jest dopuszczalne wyłącznie na warunkach określonych w § 4 ust. 5<!-- ref:rola-rankingu/powolanie-uzupelniajace -->. Powołania uzupełniającego nie stosuje się do Drużynowych Mistrzostw Świata ani Drużynowych Mistrzostw Europy; skład wybiera się wyłącznie z właściwej puli kandydatów.

## Rozdział 5 — Terminarz procesu powoływania <!-- chapter:terminarz -->
<!-- scope: terminy, deklaracje, odpowiedzialność, korekty danych i dokumentacja powołań -->

### § 17 — Terminy procesu <!-- section:zasady-terminarza -->
...
2. <!-- unit:terminarz-t90 --> Na 90<!-- days:otwarcie --> dni przed pierwszym dniem zawodów (T−90<!-- term:otwarcie -->) SPWS otwiera proces powoływania, zamyka dane wynikowe wykorzystywane w tym cyklu, ogłasza zasady postępowania i wzywa zawodników do składania deklaracji gotowości. Wyniki uzyskane po tym dniu nie wpływają na kolejność kandydatów w tym cyklu, z zastrzeżeniem zasad ustalania ostatecznego składu drużyny na Mistrzostwa Świata.

3. <!-- unit:terminarz-deklaracje --> Zawodnik składa deklarację gotowości od T−90<!-- term:otwarcie --> do T−75<!-- term:karty --> włącznie.

4. <!-- unit:terminarz-t75 --> Najpóźniej na 75<!-- days:karty --> dni przed pierwszym dniem zawodów (T−75<!-- term:karty -->) SPWS udostępnia zawodnikom i ich trenerom projekty kart zawodników. Karta przedstawia wyniki przyjęte do oceny oraz podstawę proponowanej kolejności. Od T−75<!-- term:karty --> do T−60<!-- term:propozycja --> zawodnik może zgłaszać brakujące wyniki uzyskane nie później niż w T−90<!-- term:otwarcie --> oraz błędy w swoich danych.

5. <!-- unit:terminarz-t60 --> Najpóźniej na 60<!-- days:propozycja --> dni przed pierwszym dniem zawodów (T−60<!-- term:propozycja -->) SPWS przekazuje PZSz uszeregowaną propozycję kandydatów do reprezentacji Polski wraz z kartami, pisemnymi uzasadnieniami oraz propozycją obsadzenia każdej kategorii rozgrywanej w danych zawodach. Przed przekazaniem propozycji SPWS weryfikuje warunki uwzględnienia kandydatów i wprowadza zweryfikowane korekty danych.

6. <!-- unit:terminarz-druzyna-ms --> Propozycja przekazywana PZSz w terminie T−60<!-- term:propozycja --> wskazuje ośmioosobową pulę kandydatów do drużyny na Mistrzostwa Świata oraz dwóch zawodników mających zapewnione miejsca w jej składzie. Pozostałych trzech zawodników wybiera się na miejscu podczas mistrzostw, po zakończeniu turnieju indywidualnego, w dniu poprzedzającym turniej drużynowy. Nie wyznacza się zawodnika rezerwowego.

7. <!-- unit:terminarz-druzyna-me --> Propozycja przekazywana PZSz w terminie T−60<!-- term:propozycja --> na Drużynowe Mistrzostwa Europy obejmuje skład pięcioosobowej drużyny wraz ze wskazaniem zawodnika rezerwowego.

8. <!-- unit:terminarz-spws --> SPWS odpowiada za zebranie i weryfikację wyników, przygotowanie kart zawodników, uszeregowanie kandydatów wraz z pisemnymi uzasadnieniami, rozpatrzenie reklamacji danych oraz przekazanie propozycji PZSz w terminie T−60<!-- term:propozycja -->.
...
10. <!-- unit:terminarz-reklamacje --> Reklamacja danych dotyczy błędów faktycznych, w szczególności pominięcia wyniku, błędnej pisowni nazwiska albo przypisania wyniku niewłaściwemu zawodnikowi. Korekta danych nie oznacza dopuszczenia wyników uzyskanych po T−90<!-- term:otwarcie -->. Zweryfikowaną korektę wprowadza się do karty przed przekazaniem propozycji PZSz w T−60<!-- term:propozycja -->.

11. <!-- unit:terminarz-zastrzezenia --> Po T−60<!-- term:propozycja --> zawodnik może zgłosić zastrzeżenie do oceny lub uzasadnienia dotyczącego jego kandydatury. SPWS odpowiada pisemnie. Zgłoszenie zastrzeżenia nie wstrzymuje dalszego procesu powoływania.
...
| --- | --- | --- |
| T−90<!-- term:otwarcie --> | Otwarcie procesu | Zamknięcie danych i otwarcie deklaracji |
| T−75<!-- term:karty --> | Karty zawodników | Koniec deklaracji; początek reklamacji |
| T−60<!-- term:propozycja --> | Propozycja do PZSz | MŚ: pula 8 i dwóch liderów. ME: drużyna 5 i rezerwowy. Karty i uzasadnienia. |
| T<!-- term:zawody --> | Początek zawodów | MŚ: po turnieju indywidualnym, dzień przed drużynowym — pełna piątka, bez rezerwowego. |
...
| Termin | Zdarzenie | Zakres |
| --- | --- | --- |
| T−90<!-- term:otwarcie --> | Otwarcie procesu | SPWS zamyka dane i wzywa do deklaracji. Późniejsze wyniki nie zmieniają kolejności kandydatów; wyjątek dotyczy wyboru drużyny na MŚ po rywalizacji indywidualnej. |
| T−90<!-- term:otwarcie --> → T−75<!-- term:karty --> | Deklaracje | Zawodnik deklaruje gotowość do T−75<!-- term:karty --> włącznie. |
| T−75<!-- term:karty --> → T−60<!-- term:propozycja --> | Karty i reklamacje | Karty są udostępnione najpóźniej w T−75<!-- term:karty -->. Zawodnik zgłasza błędy i brakujące wyniki sprzed zamknięcia danych. Zweryfikowane korekty wchodzą przed przekazaniem propozycji. |
| T−60<!-- term:propozycja --> | Propozycja do PZSz | MŚ: pula ośmiu kandydatów i dwóch liderów z zapewnionymi miejscami. ME: proponowana piątka i rezerwowy. Karty oraz uzasadnienia do PZSz. |
...
| Po T−60<!-- term:propozycja --> | Zastrzeżenia do oceny | SPWS odpowiada pisemnie; zastrzeżenie nie wstrzymuje dalszego procesu. |
...
| --- | --- |
| SPWS | Wyniki, weryfikacja warunków, karty, kolejność kandydatów, uzasadnienia, reklamacje oraz propozycja do T−60<!-- term:propozycja -->. |
| PZSz | Wybór, nominacja i zgłoszenie imienne; pisemny powód odstępstwa od zaproponowanej kolejności. |
| Zawodnik | Deklaracja od T−90<!-- term:otwarcie --> do T−75<!-- term:karty --> włącznie oraz zgłoszenie błędów w oknie reklamacji. |
...
## Rozdział 6 — Ocena regulaminu i doskonalenie metody <!-- chapter:ocena -->
<!-- scope: ewaluacja sezonowa i przygotowanie zmian -->

### § 18 — Posezonowa ocena działania regulaminu <!-- section:zasady-oceny -->
...
## Rozdział 7 — Postanowienia końcowe <!-- chapter:koncowe -->
<!-- scope: wejście w życie i przepis przejściowy -->

### § 19 — Wejście w życie <!-- section:wejscie-w-zycie -->
...
<!-- publication:running -->
Regulamin powoływania reprezentacji Polski weteranów

Projekt regulaminu  ·  sezon 2026/2027

Projekt · wersja 0.1     |     Strona 1<!-- field:PAGE --> z 1<!-- field:NUMPAGES -->
<!-- /publication -->
